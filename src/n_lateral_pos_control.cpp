...
// rosrun bam_experimental n_lateral_pos_control --fdcanusb /dev/ttyACM0
...
int main(int argc, char** argv) {
  ...
  kp_scale = find_int_arg("--kp_scale", secondary_bus);
  ...
  position_cmd.kp_scale = kp_scale;

  std::cout << "kp_scale: " << kp_scale << std::endl;
